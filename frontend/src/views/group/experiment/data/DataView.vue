...
import AnalysisView from "@/views/group/experiment/data/analysis/AnalysisView.vue";
import DataWorkspaceView from "@/views/group/experiment/data/workspace/DataWorkspaceView.vue";
