...
import GeneralSettingsView from "@/views/group/experiment/image/options/settings/general/GeneralSettingsView.vue";
import { Component, Vue } from "vue-property-decorator";
import BrushableHistogram from "@/components/BrushableHistogram.vue";
import PresetsView from "@/views/group/experiment/image/options/settings/PresetsView.vue";
