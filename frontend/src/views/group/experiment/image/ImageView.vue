...
import VisualizationView from "@/views/group/experiment/image/visualization/VisualizationView.vue";
import ImageWorkspaceView from "@/views/group/experiment/image/workspace/ImageWorkspaceView.vue";
import { Component, Vue } from "vue-property-decorator";
import OptionsView from "@/views/group/experiment/image/options/OptionsView.vue";
