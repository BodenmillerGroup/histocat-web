...
<script lang="ts">
  ...
  import ScatterPlotSettingsView from '@/views/main/experiment/analysis/scatter/ScatterPlotSettingsView.vue';
  import ScatterPlotView from '@/views/main/experiment/analysis/scatter/ScatterPlotView.vue';
  import { Component, Vue } from 'vue-property-decorator';

  @Component({
    components: { ScatterPlotSettingsView, ScatterPlotView },
  })
