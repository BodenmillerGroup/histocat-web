...
import AnalysisView from "@/views/main/group/experiment/data/analysis/AnalysisView.vue";
import DataWorkspaceView from "@/views/main/group/experiment/data/workspace/DataWorkspaceView.vue";
