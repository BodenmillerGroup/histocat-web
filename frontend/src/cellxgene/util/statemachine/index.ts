...
export default class StateMachine {
  ...
  constructor(initState, transitions: any[], onError) {
  ...
  clone(initState) {
    const fsm = new StateMachine(initState, [], this.onError);
  ...
  next(event, data) {
    ...
    return transition.action ? transition.action(this, transition, data) : undefined;
  }
}
