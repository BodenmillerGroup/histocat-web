...
export default class HeatmapCompositeTextLayer extends CompositeLayer<any, any> {
  _renderAxisTopLayers() {
    ...
    return [
      new TextLayer({
        ...
        getTextAnchor: 'start',
        getColor: () => THEME_TO_TEXT_COLOR[theme as "light" | "dark"] as any,
