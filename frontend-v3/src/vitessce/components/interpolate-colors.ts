...
function rgbSpline(spline: any) {
  return (colors: any[][]) => {
    ...
    g = spline(g);
    b = spline(b);
    return (t: number) => [(r as any)(t), (r as any)(t), (r as any)(t)];
  };
}

// Reference: https://github.com/d3/d3-interpolate/blob/594a32af1fe1118812b439012c2cb742e907c0c0/src/basis.js
function basis(values: any[]) {
  function innerBasis(t1: number, v0: number, v1: number, v2: number, v3: number) {
 ...
 */
export function getCellColors(params: any) {
  const {
    cellColorEncoding,
    expressionData,
