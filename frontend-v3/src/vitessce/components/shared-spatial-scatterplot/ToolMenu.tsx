...
export default function ToolMenu(props: { setActiveTool: any; activeTool: any; visibleTools?: { pan: boolean; selectRectangle: boolean; selectLasso: boolean; } | undefined; }) {
  const {
    setActiveTool,
    activeTool,
