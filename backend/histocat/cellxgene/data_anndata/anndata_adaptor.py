...
import histocat.cellxgene.compute.diffexp_generic as diffexp_generic
from histocat.cellxgene.common.app_config import AppConfig
from histocat.cellxgene.common.constants import MAX_LAYOUTS, Axis
...
from histocat.cellxgene.compute.scanpy import scanpy_umap
...
class AnndataAdaptor(DataAdaptor):
    def __init__(self, data_locator: DataLocator, config: Optional[AppConfig] = None):
    ...
    @staticmethod
    def pre_load_validation(data_locator: DataLocator):
    ...
    def _load_data(self, data_locator: DataLocator):
