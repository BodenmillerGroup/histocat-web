...
from app.modules.share.service import get_by_user_id
from app.modules.user.models import User

from .models import EXPERIMENT_LOCATION_FORMAT, Experiment
...
def create(session: Session, *, user_id: int, params: ExperimentCreateDto) -> Experiment:
    entity = Experiment(
...
def update(session: Session, *, item: Experiment, params: ExperimentUpdateDto) -> Experiment:
